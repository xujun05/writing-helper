  ...
  return (
    <div className="container mx-auto p-4 md:p-8 bg-gray-900 text-gray-100 min-h-screen">
      <header className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-purple-400">{platformName}</h1>
        <p className="text-lg text-gray-400 mt-2">{platformDescription}</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
          <form onSubmit={handleSubmit}>
            ...
            {showApiSettings && <hr className="my-6 border-gray-700" />}

            <div className="space-y-6 mb-6">
              <h2 className="text-2xl font-semibold text-purple-300 mb-4">Content Settings</h2>
              <div>
              ...
              <div>
                <label htmlFor="wordCount" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <button
              ...
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-md transition duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
          <h2 className="text-2xl font-semibold text-purple-300 mb-4">Generated Result</h2>
          {isLoading && (
            <div className="flex justify-center items-center h-64">
              <div className="animate-pulse text-center">
                ...
                <p className="mt-2 text-lg text-gray-400">Generating content... please wait.</p>
              </div>
            </div>
          )}

          {error && (
            <div className="bg-red-800 border border-red-700 text-red-100 px-4 py-3 rounded-md relative mb-4" role="alert">
          ...
          {apiResponseDetails && (
            <div className="mt-6 p-4 bg-gray-700 rounded-md text-xs text-gray-300">
              <h3 className="font-semibold text-sm text-purple-300 mb-2">API Response Details:</h3>
