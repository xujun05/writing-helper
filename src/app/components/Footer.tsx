      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <div className="flex space-x-8 mb-4">
            <a href="https://github.com/GeekyWizKid/writing-helper" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://twitter.com/named_Das" target="_blank" rel="noopener noreferrer" aria-label="Twitter/X">
              <svg className="h-6 w-6 text-gray-600 hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24">
